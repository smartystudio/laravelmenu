...
<div class="card">
    ...
    <div id="collapse{{ $id }}" class="collapse @isset($show) show @endisset" aria-labelledby="heading{{ $id }}" data-parent="#accordion">
        <div class="card-body box-links-for-menu">
            <form method="get" action="">
                ...
                @endif
                <div class="form-group">
                    <button type="button" onclick="addItemMenu(this, 'custom')" class="btn btn-info btn-sm float-right mr-2 mb-2">
                        {{ __('Add to Menu') }}
                    </button>
                </div>
            </form>
