...
namespace SmartyStudio\Menu\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Foundation\AliasLoader;
use SmartyStudio\Menu\WMenu;
...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../', 'smartystudio-menu');
        ...
        $this->publishes([
            __DIR__ . '/../../resources/views' => resource_path('views/vendor/smartystudio-menu'),
        ], 'laravel-menu-view');

        $this->publishes([
            __DIR__ . '/../../public' => public_path('vendor/smartystudio-menu'),
        ], 'laravel-menu-public');
    ...
    {
        $this->app->bind('smartystudio-menu', function () {
            return new WMenu();
        });

        $this->app->make('SmartyStudio\Menu\Http\Controllers\MenuController');
